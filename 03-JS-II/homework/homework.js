...
function operadoresLogicos(num1, num2, num3) {
  ...
  for (num1, num2, num3; num1 === 0 || num2 === 0 || num3 === 0;) {
    return ('Error');
  }
  for (num1; num1 > 0 && num1 > num2 && num1 > num3;) {
    return ('Número 1 es mayor y positivo');
  }
  for (num3; num3 > num1 && num3 > num2; num3++) {
    return (num3 + 1);
  }
  return false;
}
...
function esVerdadero(valor){
  ...
  for (valor; valor === 1 || valor === 0 || valor === true || valor === false; ) {
